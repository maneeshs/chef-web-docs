=====================================================
Send Chef Automate Visibility notifications to a custom Webhook
=====================================================
`[edit on GitHub] <https://github.com/chef/chef-web-docs/blob/master/chef_master/source/integrate_notifications_webhook.rst>`__
...
Chef Automate may be configured to post JSON messages to any compatible webhook when it detects certain issues with the nodes you are managing.
...
#. Click **Create Notification** and select **Add a webhook notification** from the drop-down menu.
...
Any notifications generated with by sent as an HTTP POST to the given URL with a body that looks like the examples below.
